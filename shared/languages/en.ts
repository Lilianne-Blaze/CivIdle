export const EN = {
   ...
   Neighbors: "Neighbors",
   NeighborsDescHTML:
      "You get <b>+%{neighbor} Production Multiplier</b> for each neighbor's tile, and <b>+%{ally} Production Multiplier</b> for each ally's tile. To become an ally with your neighbor, choose the same flag (except for the Earth flag) as them",
   Ally: "Ally",
   BecomeAllyTooltip: "To become an ally with your neighbor, choose the same flag (except for the Earth flag) as them",
   Neighbor: "Neighbor",
   ColorGreen: "Green",
   ...
   LiberalismLevel5DescHTMLV2: "All buildings get <b>+5 Building Level Boost</b> from Electrification",
